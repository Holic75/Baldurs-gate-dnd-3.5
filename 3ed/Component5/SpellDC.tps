	...
	LAF ADD_FEATS_LVL INT_VAR min_level=1 max_level=1 d_level=1 add_at_level1=1 
						...
						feat_name=~SPDCWFT~ caption=~SPDCWIZ~ END
	LAF ADD_FEATS_LVL INT_VAR min_level=1 max_level=1 d_level=1 add_at_level1=1 
						STR_VAR clab=~\(\(CLABMA01\)\|\(CLABSO.*\)\)\.2DA~ mask_file=~3ed/Feats/FeatAttribution/SFTCRES.SPL~
						feat_name=~SPDCSFT~ caption=~SPDCSOR~ END
	LAF ADD_FEATS_LVL INT_VAR min_level=1 max_level=1 d_level=1 add_at_level1=1 
						STR_VAR clab=~CLABBA.*\.2DA~ mask_file=~3ed/Feats/FeatAttribution/SFTCREAL.SPL~
						feat_name=~SPDCSFT~ caption=~SPDCBAR~ END

						
	LAF ADD_FEATS_LVL INT_VAR min_level=1 max_level=1 d_level=1 add_at_level1=1 
						STR_VAR clab=~\(\(CLABPR.*\)\|\(CLABDR.*\)\|\(OHTYR\)\)\.2DA~ mask_file=~3ed/Feats/FeatAttribution/SFTCREAL.SPL~
						feat_name=~SPDCPFT~ caption=~SPDCPRI~ END			
	LAF ADD_FEATS_LVL INT_VAR min_level=1 max_level=1 d_level=1 add_at_level1=1 
						STR_VAR clab=~CLABSH.*\.2DA~ mask_file=~3ed/Feats/FeatAttribution/SFTCREAL.SPL~
						feat_name=~SPDCHFT~ caption=~SPDCSHA~ END							
	LAF ADD_FEATS_LVL INT_VAR min_level=4 max_level=4 d_level=1 add_at_level1=0 
						STR_VAR clab=~CLABPA.*\.2DA~ mask_file=~3ed/Feats/FeatAttribution/SFTCREAL.SPL~
						feat_name=~SPDCLFT~ caption=~SPDCPAL~ END	
	LAF ADD_FEATS_LVL INT_VAR min_level=4 max_level=4 d_level=1 add_at_level1=0 
						STR_VAR clab=~CLABRN.*\.2DA~ mask_file=~3ed/Feats/FeatAttribution/SFTCRER.SPL~
						feat_name=~SPDCRFT~ caption=~SPDCRNG~ END