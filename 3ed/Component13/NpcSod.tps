...
LAF SET_DEFAULT_NPC_STATS INT_VAR Str = 11 Dex = 16 Con = 14 Int = 16 Wis = 9 Cha = 10  Lockpick = 5 FindTraps = 5 RemoveKnownSpells = 0 RemoveMemorizedSpells = 0 InitialXp = 64000
                          STR_VAR NpcName = ~SAFANA7~ ScriptName = ~BDSAFANA~ ClassName = ~THIEF~ KitName = ~SWASHBUCKLER~  END   
                                 
LAF SET_DEFAULT_NPC_STATS INT_VAR Str = 10 Dex = 12 Con = 14 Int = 18 Wis = 9 Cha = 10 RemoveKnownSpells = 0 InitialXp = 64000
...
LAF SET_DEFAULT_NPC_STATS INT_VAR Str = 14 Dex = 16 Con = 12 Int = 10 Wis = 15 Cha = 10 InitialXp = 64000  
                          STR_VAR NpcName = ~RASAAD7~ ScriptName = ~BDRASAAD~ ClassName = ~MONK~ KitName = ~SUN_SOUL~ END       

LAF SET_DEFAULT_NPC_STATS INT_VAR Str = 18 Dex = 10 Con = 13 Int = 8 Wis = 13 Cha = 15 InitialXp = 64000  
...
LAF SET_DEFAULT_NPC_STATS INT_VAR Str = 15 Dex = 16 Con = 14 Int = 10 Wis = 13 Cha = 9 InitialXp = 64000 
    STR_VAR NpcName = ~CORWIN7~ ScriptName = ~BDCORWIN~ ClassName = ~RANGER~ KitName=~FERALAN~  END 

LAF SET_DEFAULT_NPC_STATS INT_VAR Str = 14 Dex = 14 Con = 14 Int = 13 Wis = 9 Cha = 15  RemoveKnownSpells = 0 InitialXp = 64000 
    STR_VAR NpcName = ~VOGHIL7~ ScriptName = ~BDVOGHIL~ ClassName = ~BARD~ KitName=~SKALD~  END      
    
LAF SET_DEFAULT_NPC_STATS INT_VAR Str = 12 Dex = 10 Con = 16 Int = 10 Wis = 16 Cha = 14 InitialXp = 64000
