    ...
    ELSE ACTION_IF (~%GameId%~ STR_EQ ~Bg2~) BEGIN
        ...
        LAF SET_DEFAULT_NPC_STATS INT_VAR Str = 12 Dex = 18 Con = 14 Int = 10 Wis = 14 Cha = 10  
                                  STR_VAR NpcName = ~MAZZY+.*~ ScriptName = ~MAZZY~ ClassName = ~FIGHTER~ KitName= ~KENSAI~  RemoveKnownSpells = 0 RemoveMemorizedSpells = 0 END                                         
        ...
        LAF SET_DEFAULT_NPC_STATS INT_VAR Str = 10 Dex = 18 Con = 10 Int = 16 Wis = 16 Cha = 12  
                STR_VAR NpcName = ~AERIE[0-9]+.*~ ScriptName = ~AERIE~ ClassName = ~CLERIC_MAGE~ RemoveKnownSpells = 0 END  
        ...
        LAF SET_DEFAULT_NPC_STATS INT_VAR Str = 16 Dex = 14 Con = 14 Int = 14 Wis = 10 Cha = 10  
                STR_VAR NpcName = ~SAREVOK~ ScriptName = ~SAREV25~ ClassName = ~FIGHTER~ RemoveKnownSpells = 0 END       
        ...
        LAF SET_DEFAULT_NPC_STATS INT_VAR Str = 16 Dex = 20 Con = 12 Int = 18 Wis = 12 Cha = 14  
                STR_VAR NpcName = ~ohhfak+.*~ ScriptName = ~OHHFAK~ ClassName = ~THIEF~ KitName = ~SHADOWDANCER~ RemoveKnownSpells = 0 RemoveMemorizedSpells = 0 END                      
    END
